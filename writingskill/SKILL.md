...
用户给的命题常常说不清——很可能连产品都没讲明白。做任何写作能力前，先用引导提问把下面四件事问清楚，别直接照着用户的话写：

1. **产品**：写的是什么东西？别用"我们产品很好"这种，要说清它是什么、干什么。
2. **人群**：写给谁看？他们现在的认知 / 痛点 / 期待是什么？
3. **卖点**：用户只能记住一个词，是哪个？别堆优点。
4. **差异**：跟用户见过的同类比，哪里不一样？凭什么选你而不选别的？

（用户说不清很正常——你的任务是把这些问出来，而不是把一句不清不楚的命题写漂亮。）
